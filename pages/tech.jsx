...
const tech = () => {
  const data = [
    ...
    },
    {
      title: "Kotlin",
      id: 2,
      main: "/icons/kotlin-original.svg",
      desc: "Kotlin is a programming language that makes coding concise, cross-platform, and fun.",
      tag: "code",
      bg: "bg-blue-50",
      text: "text-blue-500",
    },
    ...
    },
    {
      title: "Docker",
      id: 7,
      main: "/icons/docker-icon.svg",
      desc: "A platform designed to help developers build, share, and run container applications.",
      tag: "platform",
      bg: "bg-pink-300",
      text: "text-pink-800",
    },
    {
      title: "Tensorflow",
      id: 8,
      main: "/icons/tensorflow-icon.svg",
    ...
    },
    {
      title: "MongoDB",
      id: 9,
      main: "/icons/mongodb-icon.svg",
      desc: "A cross-platform, document-oriented database program.",
      tag: "db",
      bg: "bg-orange-500",
    ...
    },
    {
      title: "Firebase",
      id: 11,
      main: "/icons/firebase-original.svg",
      desc: "A platform for mobile and web app development that helps build apps and games that users will love",
      tag: "platform",
      bg: "bg-orange-500",
      text: "text-orange-100",
    },
    {
      title: "Google Cloud",
      id: 9,
      main: "/icons/google_cloud-icon.svg",
    ...
    },
    {
      title: "RabbitMQ",
      id: 10,
      main: "/icons/rabbitmq-icon.svg",
      desc: "An open-source message-broker software.",
      tag: "code",
      bg: "bg-gray-900",
      text: "text-gray-100",
    },
    {
      title: "Flutter",
      id: 11,
      main: "/icons/flutterio-icon.svg",
      desc: "An open source framework for building beautiful, natively compiled, multi-platform applications from a single codebase.",
      tag: "framework",
      bg: "bg-orange-500",
      text: "text-orange-100",
    },
      ...
      <main className="max-w-screen max-w-5xl mx-auto">
        <div className="pt-24 flex flex-col mx-auto">
          ...
          <p className="mt-8 max-w-xl text-center md:w-[70%] mx-auto text-sm md:text-base lg:text-xl mb-2 px-2">
            Technologies and tools that i use for most of my projects.
          </p>
